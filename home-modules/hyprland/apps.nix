  ...
  config = lib.mkIf cfg.enable {
    ...
    systemd.user.services.keepassxc-w4 = {
      ...
      Service = self.data.systemdHarden // {
        ...
        BindPaths = [
          "%t"
          "%h/.local/share/keepassxc:%h/.config/keepassxc"
          "%h/.cache/keepassxc"
          "-/var/lib/syncthing"
          "-%h/.mozilla/native-messaging-hosts"
    ...
    systemd.user.services.telegram-w5 = {
      ...
      Service = self.data.systemdHarden // {
        ...
        BindPaths = [
          "%t"
          "%h/.local/share/TelegramDesktop"
          "%h/Downloads/TelegramDesktop"
        ];
        BindReadOnlyPaths = publicBinds;
    ...
    xdg.desktopEntries =
      ...
      // {
        chromium-browser = {
          name = "Chromium";
          exec = "systemd-run --user -G chromium %U";
          icon = "chromium";
        };
        firefox = {
          name = "Firefox";
